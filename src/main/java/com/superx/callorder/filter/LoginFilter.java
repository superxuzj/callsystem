package com.superx.callorder.filter;
...
public class LoginFilter implements Filter{
	...
	*/    
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		//静态资源请求直接放行
		if(httpRequest.getRequestURI().indexOf("/callstatic")!=-1){
        ...
        //没有登录，需要登录
        if (session == null || 
        		session.getAttribute(Constant.ISLOGIN) == null ||
        		session.getAttribute(Constant.USERTYPE)==null||
        		session.getAttribute(Constant.USERID)==null) {
