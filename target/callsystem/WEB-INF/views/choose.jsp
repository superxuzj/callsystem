...
.main{ position:absolute;left:50%; top:43%; background:url(<%=request.getContextPath()%>/callstatic/images/choose.png) no-repeat; width:850px; height:640px; margin:-234px 0 0 -386px;}
.input-box{ position:absolute; top:120px; left:465px;color:#0952a1;}
.input-box .zxqh{ position:absolute; top:180px; left:25px;color:#0952a1;}/*相对于input-box的位置*/
...
<body>
	...
	<!-- <div class="container" id="imgcenter">
		<div class="row-fluid">
			<div class="span12" align="center" >
			   <img alt="" src="images/choose.jpg"  ismap="ismap">
		   </div>
		</div>
	</div> -->
	...
	<div class="container" id="imgcenter">
		...
		<div class="login-box">
			<div class="input-box">
				<a href="#" onclick="order_hnum()">
					<c:choose>
					<c:when test="${hstatus== '3'}">
						<img height="50" width="330" src="<%=request.getContextPath()%>/callstatic/images/unhxqh1.png">
					</c:when>
					<c:otherwise>
						<img height="50" width="330" src="<%=request.getContextPath()%>/callstatic/images/hxqh.png">
					</c:otherwise>
					</c:choose>
				</a>
				<p></p>
				<a href="#" onclick="order_znum()">
					<c:choose>
					<c:when test="${zstatus=='3'}">
						<img class="zxqh" height="50" width="500px" src="<%=request.getContextPath()%>/callstatic/images/unzxqh1.png">
					</c:when>
					<c:otherwise>
						<img height="50" class="zxqh" width="500px" src="<%=request.getContextPath()%>/callstatic/images/zxqh.png">
					</c:otherwise>
					</c:choose>
				</a>
			</div>
...
<!-- <jsp:include page="common/bottom.jsp" flush="true"/>  -->
	...
	/* $("#typeh").click(function(){
		window.location.href="staffh.html"; 

	});
	$("#typez").click(function(){
		window.location.href="staffz.html"; 
	}); */
